...
class cog_help(commands.Cog):
    ...
    async def wiki(self, ctx):
        ...
        embedVar.add_field(name="Test Wiki", value="https://mcdftestingwiki.miraheze.org")
        embedVar.add_field(name="Github", value="https://github.com/Minecraft-Discontinued-Features", inline=False)
        embedVar.add_field(name="Youtube", value="https://www.youtube.com/channel/UC8gg3Ak2a8PO0iiwv9I2eNA (plans for this account are currently on hold)")
        embedVar.add_field(name="Reddit", value="https://www.reddit.com/r/DiscontinuedMC")
        embedVar.set_thumbnail(url=thumbnail_image)
        embedVar.set_footer(text=footer_text)
        await ctx.send(embed=embedVar)
